...
namespace SonarTestBadCode.Helpers
{
    public class ValidationHelper
    {
        ...
        public int GetMaxFieldLength() => MaxFieldLength;
        ...
        public bool CanRetryCompliance(int attempt, int maxAttempts)
        {
            ...
            {
                return false; // Corrected the condition to avoid always true
            }
            return false;
        }
        ...
        public int GetDefaultComplianceLimit() => DefaultComplianceLimit;
