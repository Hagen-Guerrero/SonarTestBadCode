...
namespace SonarTestBadCode.Helpers
{
    public class ValidationHelper
    {
        ...
        {
            const string ValidationFailed = "validation_failed";
        ...
        {
            bool c1 = a > b; // Corrected from a > a
            bool c2 = b < a; // Corrected from b < b
            bool c3 = s == null; // Corrected from s == s
            return c1 || c2 || c3;
        }
        ...
        public bool CheckComplianceFlags(int code, bool enabled)
        {
            ...
            bool flag2 = enabled;  // enabled || true is always true
        ...
        {
            const string RuleViolation = "rule_violation";
