...
namespace SonarTestBadCode.Services
{
    ...
    public class DataService
    {
        ...
        private static readonly string _connectionString = null; // Made readonly
        ...
        public const int DefaultTimeout = 30; // Declared as constant
        ...
        public const string SyncFailureReason = "connection_lost"; // Declared as constant
        ...
        public const int DefaultSyncLimit = 3; // Declared as constant
