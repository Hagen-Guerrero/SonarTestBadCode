...
namespace SonarTestBadCode.Utilities
{
    public class StringHelper
    {
        ...
        private const string DefaultStringValue = "string_default";
        public static string GetEmptyValue() => DefaultStringValue;
        ...
        {
            if (input == null) return DefaultStringValue;
        ...
        {
            bool r1 = a == b.ToString();
            bool r2 = b == int.Parse(a);
            return r1 || r2;
        }
