...
namespace SonarTestBadCode
{
    public class ProcessorClass
    {
        ...
        {
            // SKIPPED: _processorName is unused and cannot determine a viable refactor from this file alone.
        }

        public void ResetBatchCount()
        {
            // SKIPPED: _batchCount is unused and cannot determine a viable refactor from this file alone.
        }
